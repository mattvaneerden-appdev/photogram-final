class UserAuthenticationController < ApplicationController
  ...
  def show
    ...
    render({ :template => "user/show_profile.html.erb" })
  end
  ...
  def liked_page
    ...
    render({ :template => "user/show_liked.html.erb" })
  end
  ...
  def feed_page
    ...
    render({ :template => "user/show_feed.html.erb" })
  end
  ...
  def discover_page
    ...
    render({ :template => "user/show_discover.html.erb" })
  end
